...
struct pci_dev {
	...
	struct pci_tdisp_dev *tdisp_dev;
	struct pci_tdi *tdi;
#endif
};
...
#ifdef CONFIG_PCI_TDISP
static inline struct pci_tdi *to_pci_tdi(struct pci_dev *pdev)
{
	if (pdev)
		return pdev->tdi;
	return NULL;
...
#else
static inline struct pci_tdi *to_pci_tdi(struct pci_dev *pdev) { return NULL; }
#endif
